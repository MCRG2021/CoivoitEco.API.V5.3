...
namespace CovoitEco.APP.Service.Reservation.Queries
{
    ...
    {
        public Task<int> GetIdReservationUserProfile(int idAnn, int idUser, string token);
        ...
        public Task<ReservationProfileVm> GetAllReservationProfile(int id, string token);
    }
}
