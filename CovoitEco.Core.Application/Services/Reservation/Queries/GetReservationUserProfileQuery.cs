...
{
    public class GetReservationUserProfileQuery : IRequest<ReservationUserProfileVm>
    {
        public int RES_Id { get; set; }
    }
    public class GetReservationUserProfileQueryHandler : IRequestHandler<GetReservationUserProfileQuery, ReservationUserProfileVm>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;


        public GetReservationUserProfileQueryHandler(IApplicationDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
