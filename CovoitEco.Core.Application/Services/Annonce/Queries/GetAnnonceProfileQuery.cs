...
{
    public class GetAnnonceProfileQuery : IRequest<AnnonceProfileVm>
    {
        public int ANN_Id { get; set; }
    }
    public class GetAnnonceProfileQueryHandler : IRequestHandler<GetAnnonceProfileQuery, AnnonceProfileVm>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;


        public GetAnnonceProfileQueryHandler(IApplicationDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }

        public async Task<AnnonceProfileVm> Handle(GetAnnonceProfileQuery request, CancellationToken cancellationToken)
        {
